    ...
    return(
        <Jumbotron className="about-page">
            ...
            <p>
                ...
                Основной фичей являеться то, что с легкостью можно изменить API провайдера курсов валют.
            ...
            <p>
                Сейчас используються 2 провайдера для отображения курсов за сегобня и для
